...
(function() {
    ...
    var pluginRTC = isSafari || isInternetExplorer;
    ...
    function LoadPluginRTC() {
        ...
        log(isSafari ? 'Java-Applet' : 'ActiveX', 'extension has been initialized.');
        ...
        Plugin.getUserMedia = navigator.getUserMedia = function(constraints, successCallback, errorCallback) {
            if (document.readyState !== 'complete') {
        ...
        Plugin.attachMediaStream = function(element, stream) {
        ...
        RTCIceCandidate = function(RTCIceCandidateInit, callback) {
